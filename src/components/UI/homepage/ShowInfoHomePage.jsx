...
const ShowInfoHomePage = ({ id, isOpen, onClose, rework }) => {
  ...
  if (rework) {
    return (
      <Modal onClose={onClose} className='flex justify-center items-center w-full '>
        <div className=" rounded-lg shadow-lg h-[95vh] p-4 overflow-y-auto w-full">
