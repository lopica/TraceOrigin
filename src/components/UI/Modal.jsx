...
function Modal({ onClose, children, className, primary, easy }) {
  const dynamicClasses = classNames('relative w-full max-h-[80svh] min-h-[40svh] container max-w-3xl bg-white rounded-md', {
  ...
  return createPortal(
    <div className="relative z-20">
      ...
      >
        ...
        >
          <div className="relative top-0 right-0 z-10 max-h-[80svh] min-h-[40svh]">
            <button
              onClick={onClose}
