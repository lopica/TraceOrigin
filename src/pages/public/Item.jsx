...
function Item() {
    ...
    return (
        <>
            <div className="relative text-center w-svw mb-8">
                <ul className="timeline w-svw overflow-x-auto">
            ...
            <div className="card w-[95svw] bg-base-100 shadow-xl border mb-8 mx-2">
            ...
            <div className="grid mx-6 gap-4 mb-4">
